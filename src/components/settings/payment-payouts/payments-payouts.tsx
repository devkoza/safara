...
import { MpesaIcon } from '@/components/icons/payment-methods/mpesa';
...
const paymentMethods = [
  ...
  {
    cardType: 'MPESA',
    label: 'Your Mpesa Number Ending with **245',
    icon: <MpesaIcon className="h-9 w-[60px] md:h-12 md:w-20" />,
    default: false,
    validity: '16/11/25',
  },{
    cardType: 'visa',
