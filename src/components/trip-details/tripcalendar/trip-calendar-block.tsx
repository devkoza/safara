...
export default function TripCalenderBlock() {
  ...
  return (
    <DateTime
      ...
      customInput={
        <Input
          className="[&>label>div]:!p-3"
          inputClassName={clsx(
            '!py-2 !text-base !pl-[48px]',
      ...
      labelClassName="h-[72px] text-lg lg:h-10 w-full resize-none lg:rounded-xl"
    />
  );
}
