...
import { TripCalendarPropsTypes } from '@/components/trip-details/tripcalendar/trip-calendar-types';
...
export default function TripCalendar({
  ...
  return (
    <div className={clsx('relative w-full', className)}>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-1 xl:gap-10 3xl:grid-cols-1">
