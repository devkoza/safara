...
const categories = [
  { id: 'cat-1', label: 'Fishing', checked: false },
  { id: 'cat-2', label: 'Snorkeling', checked: false },
  { id: 'cat-3', label: 'Boat Tours', checked: false },
  { id: 'cat-4', label: 'Scuba Diving', checked: false },
  { id: 'cat-4', label: 'Jet Ski', checked: false },
];
