...
const inputClasses = {
  ...
  error: '!border-red not-read-only:hover:enabled:!border-red not-read-only:focus:enabled:!border-red not-read-only:focus:!ring-red/30',
  size: {
    sm: 'py-1 !text-xs !h-8 !leading-[32px]',
    DEFAULT: 'px-4 py-2 !text-sm !h-10 lg:!h-11 2xl:!h-12 !leading-[40px] lg:!leading-[44px] 2xl:!leading-[48px]',
  ...
  variant: {
    active: {
      ...
      color: {
        DEFAULT: '!border-gray-900 focus:enabled:!border-gray-1000 focus:!ring-gray-900/20 !text-gray-1000',
        primary: '!border-primary focus:enabled:!border-primary focus:!ring-primary/30 !text-primary-dark',
        secondary: '!border-secondary focus:enabled:!border-secondary focus:!ring-secondary/30 !text-secondary-dark',
        danger: '!border-red focus:enabled:!border-red focus:!ring-red/30 !text-red-dark',
        info: '!border-blue focus:enabled:!border-blue focus:!ring-blue/30 !text-blue-dark',
        success: '!border-green focus:enabled:!border-green focus:!ring-green/30 !text-green-dark',
        warning: '!border-orange focus:enabled:!border-orange-dark/70 focus:!ring-orange/30 !text-orange-dark',
      },
    },
    flat: {
      base: '!border-0 placeholder:!opacity-90 read-only:focus:!ring-0',
      color: {
        DEFAULT: '!bg-gray-200/70 hover:enabled:!bg-gray-200/90 focus:!ring-gray-900/20 !text-gray-1000 placeholder:!text-gray-600',
        primary: '!bg-primary-lighter/70 hover:enabled:!bg-primary-lighter/90 focus:!ring-primary/30 !text-primary-dark',
        secondary: '!bg-secondary-lighter/70 hover:enabled:!bg-secondary-lighter/90 focus:!ring-secondary/30 !text-secondary-dark',
        danger: '!bg-red-lighter/70 hover:enabled:!bg-red-lighter/90 focus:!ring-red/30 !text-red-dark',
        info: '!bg-blue-lighter/70 hover:enabled:!bg-blue-lighter/90 focus:!ring-blue/30 !text-blue-dark',
        success: '!bg-green-lighter/70 hover:enabled:!bg-green-lighter/90 focus:!ring-green/30 !text-green-dark',
        warning: '!bg-orange-lighter/80 hover:enabled:!bg-orange-lighter/90 focus:!ring-orange/30 !text-orange-dark',
      },
    },
    outline: {
      ...
      color: {
        ...
        primary: 'hover:!border-primary focus:!border-primary focus:!ring-primary/30',
        secondary: 'hover:!border-secondary focus:!border-secondary focus:!ring-secondary/30',
        ...
        warning: 'hover:!border-orange focus:!border-orange-dark/70 focus:!ring-orange/30',
      },
    },
    text: {
      ...
      color: {
        ...
        warning: 'hover:!text-orange-dark focus:!ring-orange/30 !text-orange placeholder:!opacity-100',
      },
    },
  },
};
...
const dropdownClasses = {
  ...
  searchBox: '!pr-2.5 !bg-gray-0 [&>.search-box]:!w-full [&>.search-box]:!m-0 [&>.search-box]:!px-3 [&>.search-box]:!py-1 [&>.search-box]:!text-sm [&>.search-box]:!capitalize [&>.search-box]:!h-9 [&>.search-box]:!leading-[36px] [&>.search-box]:!rounded-md [&>.search-box]:!bg-transparent [&>.search-box]:!border-gray-300 [&>.search-box:focus]:!border-gray-400/70 [&>.search-box:focus]:!ring-0 [&>.search-box]:placeholder:!text-gray-500',
  highlightListColor: {
    DEFAULT: '[&>li.country.highlight]:!bg-gray-100 [&>li.country:hover]:!bg-gray-100',
    primary: '[&>li.country.highlight]:!bg-primary-lighter/70 [&>li.country:hover]:!bg-primary-lighter/70',
    secondary: '[&>li.country.highlight]:!bg-secondary-lighter/70 [&>li.country:hover]:!bg-secondary-lighter/70',
    ...
    success: '[&>li.country.highlight]:!bg-green-lighter/70 [&>li.country:hover]:!bg-green-lighter/70',
