        ...
        <Link href={Routes.public.listingDetails(title)}>
          ...
          <div className="mb-2 flex items-center gap-5">
            ...
            <div className="mb-6 flex items-center gap-5">
              <span className="relative flex items-center font-medium text-gray-dark before:absolute before:-right-3 before:block before:h-1 before:w-1 before:rounded-full before:bg-gray-dark">
                {time}
              </span>
            ...
            <div className="mb-6 flex items-center gap-5">
              <span className="relative flex items-center font-medium text-slate-600">
                {activity}
              </span>
            </div>
